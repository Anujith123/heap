...
{
	public:
		//Pointer to point to an element in the array
		int *hArr;
		...
		int parent(int i)
		{
			return (i-1)/2;                  //returns index of the parent of node
		}
		

		int left(int i)
		{
			return (i*2)+1;	            	//returns index of left child of node
		}
		

		int right(int i)
		{
			return (i*2)+2;		            //returns index of right child of node
		}
